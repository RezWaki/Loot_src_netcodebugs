...
void CHudHealth::GetPainColor( int &r, int &g, int &b )
{
	...
	//mapent = gEngfuncs.GetEntityByIndex(0);
	//mapent->curstate.rendermode = kRenderTransAdd;
...
int CHudHealth::Draw(float flTime)
{
	...
	//gHUD.DrawHudNumber(ScreenWidth/2, ScreenHeight-64, HUD_ACTIVE, player->curstate.velocity.Length(), 255, 0, 0);
	...
	if( m_iHealth <= 25 && m_iHealth > 0 ) {
		FillRGBA(0, 0, ScreenWidth, ScreenHeight, 255, 0, 0, 100);
	}
